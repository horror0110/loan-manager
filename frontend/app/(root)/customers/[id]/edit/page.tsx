// app/(root)/customers/[id]/edit/page.tsx
"use client";
...
export default function EditCustomerPage() {
  ...
  const fetchCustomer = async () => {
    try {
      ...
      alert(err.response?.data?.error || "Харилцагч татахад алдаа гарлаа");
      router.back();
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true);
      await axiosInstance.put(`/api/customers/${customerId}`, formData);
      router.push("/customers");
    } catch (err: any) {
      alert(err.response?.data?.error || "Харилцагч шинэчлэхэд алдаа гарлаа");
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Харилцагчийн мэдээллийг шинэчлэх
          </p>
        </div>
